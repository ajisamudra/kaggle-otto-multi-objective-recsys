...
fasttext_features:
	python src/features/make_item_fasttext_features.py --mode $(MODE) --istart $(START) --iend $(END)
...
train_one_ranker:
	python src/training/train_one_ranker.py --event all --n 1 --algo $(ALGO) --week w2 --eval 0
