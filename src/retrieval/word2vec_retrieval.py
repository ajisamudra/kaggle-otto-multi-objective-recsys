...
from src.utils.word2vec import load_annoy_idx_word2vec_dropn1_vect64_wdw50_embedding
...
if __name__ == "__main__":
    ...
    matrix_fact_idx = load_annoy_idx_word2vec_dropn1_vect64_wdw50_embedding()
