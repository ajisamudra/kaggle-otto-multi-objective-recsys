...
from src.utils.fasttext import load_annoy_idx_fasttext_cbow_wdw20_mn1_mx3_embedding
...
if __name__ == "__main__":
    ...
    matrix_fact_idx = load_annoy_idx_fasttext_cbow_wdw20_mn1_mx3_embedding()
