...
def train(algo: str, events: list, week: str, n: int, eval: int):
    ...
    selected_features.remove("matrix_fact_cart_order_max_recency_euclidean_distance")
    ...
    selected_features.remove("matrix_fact_cart_order_max_duration_euclidean_distance")
    selected_features.remove(
    ...
    selected_features.remove("matrix_fact_buy2buy_max_weighted_recency_cosine_distance")
    selected_features.remove(
